...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<Either<Failure, Data>> register(RegisterRequest request) async {
    try {
      ...
      if (response.data == null) {
        return Left(Failure(message: "Registration successful, but no data received"));
      }
      ...
      return Left(Failure(message: "An unexpected error occurred during registration"));
    }
  }
  ...
  Future<Either<Failure, Data>> login(LoginRequest request) async {
    try {
      ...
      return Left(Failure(message: "An unexpected error occurred during login"));
    }
  }
